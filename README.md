...
There is a exception thrown in tests:

    Running de.weltraumschaf.commons.ShutDownHookTest
    Sep 11, 2012 10:52:37 AM de.weltraumschaf.commons.ShutDownHook run
    SEVERE: null
    java.lang.RuntimeException
        at de.weltraumschaf.commons.ShutDownHook.run(ShutDownHook.java:54)
        at de.weltraumschaf.commons.ShutDownHookTest.registerAndRunCalbacksWhichThrowsException(ShutDownHookTest.java:38)
