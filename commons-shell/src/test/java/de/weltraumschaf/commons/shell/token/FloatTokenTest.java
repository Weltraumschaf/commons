...
public class FloatTokenTest {
    ...
    private final ShellToken sut = Tokens.newFloatToken(Position.NULL, "3.14", 3.14f);
    private final ShellToken sutZero = Tokens.newFloatToken(Position.NULL, "0.0", 0.0f);
