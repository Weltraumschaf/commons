 ...
 * application path, see {@code ApplicationPath}. For an annotated
 ...
 *
 * <p>Classes and methods may also be annotated with {@code  Consumes} and
 * {@code  Produces} to filter the requests they will receive.</p>
 *
 * @author Paul Sandoz
 * @author Marc Hadley
 * @since 1.0
...
@interface Path {
     ...
     *
     * <p>See  {@code <a href="http://tools.ietf.org/html/rfc5234">RFC 5234</a>}
     ...
     * the rules of
     *  {@code <a href="http://tools.ietf.org/html/rfc3986#section-3.3">RFC 3986 section 3.3</a>}.
     ...
     *  {@code <a href="http://download.oracle.com/javase/6/docs/api/java/util/regex/Pattern.html">Pattern</a>}
     * for further information on the syntax of regular expressions.
     * Values of template parameters may be extracted using {@code PathParam}.</p>
     *
