...
/**
 * A runtime exception thrown by {@code  de.weltraumschaf.commons.uri.UriBuilder#build(Object...)} methods when
 * a {@code  java.net.URI} cannot be constructed based on the current state of the
 * builder.
 *
 * @author Paul Sandoz
 * @author Marc Hadley
